...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$estudiante_id || $observacion === '') {
        $error = 'Por favor, complete todos los campos.';
    } else {
        $sql_insert = "INSERT INTO observaciones (estudiante_id, observacion, fecha, preceptor_id) VALUES (:estudiante_id, :observacion, NOW(), :preceptor_id)";
        $stmt_insert = $conn->prepare($sql_insert);
        $stmt_insert->bindParam(':estudiante_id', $estudiante_id, PDO::PARAM_INT);
        $stmt_insert->bindParam(':observacion', $observacion);
        $stmt_insert->bindParam(':preceptor_id', $preceptor_id, PDO::PARAM_INT);
        $stmt_insert->execute();
    }
}
?>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 col-lg-10 main-content p-4">
                ...
                <form method="POST" action="registrar_observaciones.php" class="card p-3 shadow">
                    <div class="mb-3">
