...
function obtenerFaltas($conn, $estudiante_id) {
    $sql = "SELECT fecha, tipo, valor, motivo
            FROM faltas
...
<head>
    <meta charset="UTF-8" />
    <title>Faltas y tardanzas</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 col-lg-10 main-content p-4">
            <h2 class="mb-4"><i class="bi bi-x-circle text-danger me-2"></i>Faltas y tardanzas de mis hijos/as</h2>
            ...
            <?php else: ?>
                <?php foreach ($hijos as $hijo): ?>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <?php
                            $faltas = obtenerFaltas($conn, $hijo['id']);
                            if (count($faltas) === 0): ?>
                                <div class="alert alert-secondary">Sin faltas/tardanzas registradas.</div>
                            <?php else: ?>
                                    ...
                                    <table class="table table-sm">
                                        ...
                                        <?php foreach ($faltas as $falta): ?>
                                            <tr>
                                                ...
                                                <td><?php echo $falta['tipo'] == 'inasistencia' ? 'Inasistencia' : 'Tardanza'; ?></td>
                                                <td><?php echo htmlspecialchars($falta['valor']); ?></td>
                                                <td><?php echo htmlspecialchars($falta['motivo']); ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    </table>
